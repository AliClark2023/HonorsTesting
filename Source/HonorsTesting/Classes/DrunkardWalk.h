...
public:
	...
	static TPair<bool,FIntVector2> Walk(const TMap<FVector, FTilePropertiesStruct> &GridRef, const FIntVector2 &GridSize, const FIntVector2 &StartPoint, const FGameplayTag TagToFind);
};
